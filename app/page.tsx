  ...
  return (
    <div className="w-100">
      ...
      <p>
        ...
        <br />
        <br />
        When I’m not working, I’m often running: a 2<span className="text-xs align-middle ps-[2px]">×</span> marathoner, I ran marathons in Amsterdam (2024) and Berlin (2025).{" "}
      </p>
